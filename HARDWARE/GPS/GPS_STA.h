...
#define GPS_PV         1 //GPIO_ReadInputDataBit(GPS_PV_ , GPS_PV_PIN)


#define GPS_COMM_CONFIG_Nuber        10             //GPS配置指令集长度
#define UB482
//#define MB2
...
extern const u8 *GPS_CMM_1HZ[GPS_COMM_CONFIG_Nuber] ;	  // 1 HZ  配置命令集
